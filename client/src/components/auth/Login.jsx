...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white py-4 sm:py-0 px-3 sm:px-6 lg:px-8">
      {/* Bazario Logo */}
      ...
      {/* Main Form Container */}
      <div className="w-[95%] sm:w-full max-w-[400px] bg-white p-6 rounded-2xl shadow-lg">
        <div className="mb-6">
        ...
        <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              maxLength="10"
              pattern="[0-9]{10}"
              className="block w-full rounded-xl border border-gray-300 px-4 py-3 text-base focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className="block w-full rounded-xl border border-gray-300 px-4 py-3 text-base focus:border-indigo-500 focus:ring-indigo-500 pr-12 transition-colors"
              />
              <button
                type="button"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-2">
            <div className="flex items-center">
              <input
                ...
                className="h-4 sm:h-4 w-4 sm:w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded cursor-pointer"
              />
              <label htmlFor="remember-me" className="ml-2 sm:ml-2 block text-sm text-gray-700 cursor-pointer">
                Remember me
              </label>
            </div>
          ...
          {serverError && (
            <div className="bg-red-50 text-sm mt-4 flex items-center gap-2 text-red-500 p-4 rounded-xl text-center">
